...
namespace Limatheus\LivewireCrud\Commands;
...
class LivewireCrudView extends GeneratorCommand
{
    ...
    public function makeInput($name)
    {
        ...
        $message = '{{ $message }}';
        if (config('livewire-crud.template') == 'tailwind') {
        ...
        if (config('livewire-crud.template') == 'bootstrap') {
  ...
  <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
    ...
    protected function getStub()
    {
        if (config('livewire-crud.template') == 'bootstrap') {
            ...
            return base_path() . '/vendor/limatheus/livewire-crud/src/stubs/bootstrap.view.php.stub';
        }

        if (file_exists(base_path() . '/stubs/view.php.stub')) {
            return base_path() . '/stubs/view.php.stub';
        }
        return base_path() . '/vendor/limatheus/livewire-crud/src/stubs/view.php.stub';
    }
