...
class Crud extends GeneratorCommand
{
    ...
    protected function getStub()
    {
        ...
        if(config('livewire-crud.template') == 'bootstrap')
        {
            ...
            return base_path().'/vendor/limatheus/livewire-crud/src/stubs/bootstrap.crud.php.stub';
        }

        if (file_exists(base_path() . '/stubs/crud.php.stub')){
            return base_path() . '/stubs/crud.php.stub';
        }
        return base_path().'/vendor/limatheus/livewire-crud/src/stubs/crud.php.stub';
    }
